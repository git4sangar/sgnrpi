...
EXE_DIR="${HOME}/proj/rpi/tools/arm-bcm2708/gcc-linaro-arm-linux-gnueabihf-raspbian/bin"
LIB_DIR="${HOME}/proj/rpi/tools/arm-bcm2708/gcc-linaro-arm-linux-gnueabihf-raspbian/lib"
...
export CC="$TARGETCC -I${HOME}/devel/lgarmuClibc/include" 
#export CFLAGS="-DFORMAT_ELF -D_INTERNAL_PCI_"
export LDFLAGS="-L${LIB_DIR} -L${HOME}/devel/lgarmuClibc/lib" 
#export LIBS
