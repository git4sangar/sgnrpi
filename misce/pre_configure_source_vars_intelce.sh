...
EXE_DIR="${HOME}/toolchains/IntelCE/IntelCE-13.98694/build_i686/i686-linux-elf/bin"
LIB_DIR="${HOME}/toolchains/IntelCE/IntelCE-13.98694/build_i686/i686-linux-elf/lib"
...
export CC="$TARGETCC -I${HOME}/devel/intelce/include"
#export CFLAGS="-DFORMAT_ELF -D_INTERNAL_PCI_" 
export LDFLAGS="-L${LIB_DIR} -L${HOME}/devel/intelce/lib"
#export LIBS
